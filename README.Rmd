...
[Click to download this repo](https://github.com/m-clark/more-mixed-models-2019/archive/master.zip).  For the workshop, you can run the code in `mmm_notebook.Rmd` as we go along.  If you just want to follow along/see the content, open `mmm.html` in your browser after downloading the repo.